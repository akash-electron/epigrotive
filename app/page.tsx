  ...
  return (
    <main ref={pageRef} className="site-shell">
      ...
      <header className={scrolled ? 'site-header scrolled' : 'site-header'}>
        <a href="#top" className="brand"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Aug%2016%2C%202026%2C%2001_25_25%20AM-5I75y5dXo5ZJjvDEBx31dB9lV9qRiy.png" alt="Epigrotive Gaming logo" /><span>EPIGROTIVE<span className="brand-sub">GAMING CULTURE</span></span></a>
